...
class DocDetailState extends State<DocDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            title: Text(ttl != "" ? widget.doc.title : "Add new"),
                ...
                children: <Widget>[
                  TextFormField (
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'How you gonna call this?',
                      labelText: 'Title',
                    ),
                  ),
                  Row(children: <Widget>[
                    Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: 'Deadline date (i.e. ' + DateUtils.daysAheadAsStr(daysAhead) + ')',
                  ...
                  Row(children: <Widget>[
                    Expanded(child: Text('Alert Options')),
                  ]),
                  Row(children: <Widget>[
                    Expanded(child: Text('1: 1.5 & 1 year/s')),
                    Switch(
                  ...
                  Row(children: <Widget>[
                    Expanded(child: Text('2: 6 months')),
                    Switch(
                  ...
                  Row(children: <Widget>[
                    Expanded(child: Text('3: 3 months')),
                    Switch(
                  ...
                  Row(children: <Widget>[
                    Expanded(child: Text('4: 1 month (or less)')),
                    Switch(
